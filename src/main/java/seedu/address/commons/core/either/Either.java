package seedu.address.commons.core.either;
...
public abstract class Either<A, B> {
    ...
    public boolean isLeft() {
        return (this instanceof LeftEither);
    }
    ...
    public boolean isRight() {
        return (this instanceof RightEither);
    }

    /**
     * get Left value.
     * @return: left value.
     * @throws IllegalAccessError error
     */
    public A getLeft() throws IllegalAccessError {
        if (!isLeft()) {
            throw new IllegalAccessError();
        }
        return ((LeftEither<A, B>) this).getLeft();
    }
     ...
     * @throws IllegalAccessError error
     */
    public B getRight() throws IllegalAccessError {
        if (!isRight()) {
            throw new IllegalAccessError();
        }
        return ((RightEither<A, B>) this).getRight();
    }
