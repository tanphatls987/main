...
public class MainWindow extends UiPart<Stage> {
     ...
     */
    void fillInnerParts() {
        mainTabPane = new MainTabPane(logic);
        mainTabPanePlaceholder.getChildren().add(mainTabPane.getRoot());

        resultDisplay = new ResultDisplay();
        resultDisplayPlaceholder.getChildren().add(resultDisplay.getRoot());

        StatusBarFooter statusBarFooter = new StatusBarFooter(logic.getHotelFilePath());
