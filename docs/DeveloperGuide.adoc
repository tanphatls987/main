...
.. Prerequisites: List all persons using the `switch guest` command. Multiple persons in the list.
...
.. Prerequisites: List all rooms using the `switch room` command. Multiple persons in the list.
