...
=== Search operation
Firstly, command from user will be parsed into a list of pattern contained in the search command.
Then the command when execute will filter guest list base on stored pattern.
