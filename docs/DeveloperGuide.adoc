...
:repoURL: https://github.com/AY1920S2-CS2103T-W13-2/main.git
...
|`* * *` |receptionist |change the tag of a room to served |
...
|`* *` |receptionist |apply discounts to customers' bills |
...
3.  User requests to make a reservation for the selected room(s)
4.  Morpheus will mark the reservation
+
Use case ends.
...
* 3a. The given room(s) are invalid or booked.
+
[none]
...
=== Use case: Order a room
*MSS*

1.  User requests to list the available room for the current date
2.  Morpheus shows a list of rooms that is available
3.  User requests to make a booking for the selected room(s)
4.  Morpheus will mark the booking
+
Use case ends.
