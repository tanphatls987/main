...
The sequence diagram below illustrates how the SetRoomCost command works:
...
The sequence diagram below illustrates how the RemoveChargedService command works:
