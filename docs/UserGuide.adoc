...
** `checkin` and `checkout` commands receives and returns guestss.
** `service` command charges guests for requesting services.
...
Format: `addservice i/SERVICE_ID d/DESCRIPTION c/COST`

Examples:
* `addservice i/WC d/Wash clothes c/100.00`https://xxx[]
...
* *Charge Service* : `service n/NAME p/PRICE [d/DESCRIPTION]...` +
e.g. `service n/Smith p/20.00 d/massage`
* *Make Reservation* : `reserve i/ID rn/ROOM_NUMBER fd/FROM_DATE td/TO_DATE` +
e.g. `reserve i/G1231231X rn/102 td/ 2020-12-12 td/ 2020-12-30`
