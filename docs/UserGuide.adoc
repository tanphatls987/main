...
****
* This shows important information to take note of!
****
...
=== If you would like to get help : `help`

Format: `help`

//tag::switch[]
=== If you want to switch between tabs : `switch`

Switch to and reset all filter on specified tab.
...
Examples:
* `switch guest` Switch to and reset filter on guest tab.

//end::switch[]

//tag::addguest[]
=== If you want to add a guest : `addguest`
...
=== If you want to add a room : `addroom`
...
=== If you want to delete a room : `deleteroom`
...
=== If you want to check-in a guest: `checkin`
...
=== If you want to check-out a guest: `checkout`
...
=== If you want to show a list of all the guests in the hotel: `list`
Format: `list`

//tag::findguest[]
=== If you want to locate guests by name or id: `findguest`
...
Return person with name John Doe or id A10
//end::findguest[]

=== If you want to find bookings by name, id or room number: `findbooking`
...
=== If you want to fetch the bill of a guest : `fetchbill`
...
=== If you need to delete a service from a bill : `deletecservice`

Removes a charged service from the guest's tab. +
Format: `deletecservice i/PERSON_ID rn/ROOM_NUMBER si/SERVICE_ID`

****
* Removes service from `PERSON_ID` 's bill for `ROOOM_NUMBER`.
****
...
=== If you want to make a reservation : `reserve`
...
=== If you want to locate the room of a guest : `getroom`

The command `getroom` retrieves the room number of the guest. +
Format: `getroom i/ID`
...
=== If you want to add a new room : `addroom`
...
=== If you want to add a tier to a room: `addtier`
...
=== If you want to add an available service: `addservice`
...
=== If you want to delete an available service: `deleteservice`
...
=== If you want to set the cost for a room : `setrcost`
...
=== If you need to clear all entries : `clear`
